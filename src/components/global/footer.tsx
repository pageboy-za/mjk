  ...
  return (
    <footer className="bg-gray-900" id="footer">
      <div className="px-6 py-12 mx-auto max-w-7xl md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="flex flex-col items-center mt-8 align-middle md:order-1 md:mt-0">
          <h1 className="font-serif text-2xl text-white uppercase bville font-semi-bold">
            Make Jesus Known
          </h1>
          <p className="text-xs text-white">
            A campaign from Calvary Chapel Cambridge
          </p>
        </div>
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="text-xs leading-5 text-center text-white">
            &copy; 2023 Calvary Chapel Cambridge.
          </p>
          <p className="text-xs leading-5 text-center text-white">
            Company Number: 7609516. Charity Number: 1141624.
          </p>
        </div>
      </div>
    </footer>
